        ...
        <div className="mainContainer">
            <div className="banner-container">
                <div className="banner">
                    ...
                    <img src={import.meta.env.BASE_URL + banners[currentIndex].replace(/^\//, '')} alt="banner" width="1920" height="600" />
                </div>
                ...
                {shuffledProducts.map(({id, img, model, color, category, title, price}) => (
                    <li key={id}>
                        <NavLink to={'/productDetail?id=' + id}>
                            <img src={import.meta.env.BASE_URL + img.replace(/^\//, '')} alt={title} className="thumbnail"/><br />
